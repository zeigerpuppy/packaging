...
Source0:       https://github.com/citusdata/citus-enterprise/archive/v9.1.2.tar.gz
...
%changelog
* Mon Feb 10 2020 - Burak Velioglu <velioglub@citusdata.com> 9.1.2.citus-1
- Update to Citus Enterprise 9.1.2
