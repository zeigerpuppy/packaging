...
main ()
{
  ...
  gpg_key_install_url="https://<access>:@packagecloud.io/install/repositories/citusdata/enterprise-nightlies/gpg_key_url.list?os=${os}&dist=${dist}&name=${unique_id}"
  apt_config_url="https://<access>:@packagecloud.io/install/repositories/citusdata/enterprise-nightlies/config_file.list?os=${os}&dist=${dist}&name=${unique_id}&source=script"
