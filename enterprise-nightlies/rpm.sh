...
main ()
{
  ...
  yum_repo_config_url="https://<access>:@packagecloud.io/install/repositories/citusdata/enterprise-nightlies/config_file.repo?os=${os}&dist=${dist}&name=${unique_id}&source=script"
